...
public class DeathantNestGoal extends MoveToBlockGoal {
    protected final PathfinderMob mob;

    // Constructor
    public DeathantNestGoal(PathfinderMob mob, double speedModifier, int horizontalRange, int verticalRange) {
    ...
    protected boolean isValidTarget(LevelReader level, BlockPos pos) {
        ...
        return state.is(ModBlocks.DEATHANTNEST.get());
    }
